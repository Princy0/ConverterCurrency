# Prince Prajapati
# Princepn029@gmail.com
# https://github.com/Princy0
...
class Main(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        self.config(bg='#295270')
        self.CurrencyConverter = converter

        # Create title label
        self.title_label = Label(self, text='Currency Converter', bg='#000000', fg='white', font=('Rockwell', 20), relief='raised')
        ...
        self.version_label = Label(self, text='Made with ♥ by Prince', bg='#3A3B3C', fg='white', font=('calibri', 10))
        self.version_label.place(x=400, y=400, anchor='se')

        # Create amount label
        self.amount_label = Label(self, text='Input Amount: ', bg='#000000', fg='white', font=('Courier', 15))
        ...
        # Create 'from' label
        self.base_currency_label = Label(self, text='From: ', bg='#000000', fg='white', font=('Courier', 15))
        self.base_currency_label.place(x=200, y=140, anchor='center')

        # Create 'to' label
        self.destination_currency_label = Label(self, text='To: ', bg='#000000', fg='white', font=('Courier', 15))
        self.destination_currency_label.place(x=200, y=200, anchor='center')

        # Create dropdown menusq
        ...
        self.final_result = Label(self, text='', bg='#52595D', fg='black', font=('calibri', 12), relief='sunken', width=40)
...
if __name__ == '__main__':
    converter = Converter_Currency('https://api.exchangerate.host/latest')
    Main(converter)
    mainloop()
